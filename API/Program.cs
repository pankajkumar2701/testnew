...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "testnew", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<testnewContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "testnew API v1");
