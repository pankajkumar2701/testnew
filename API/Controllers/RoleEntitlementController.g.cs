...
using testnew.Data;
using testnew.Filter;
using testnew.Entities;
using testnew.Authorization;
...
namespace testnew.Controllers
{
    ...
    {
        private readonly testnewContext _context;

        public RoleEntitlementController(testnewContext context)
        {
            _context = context;
        }
